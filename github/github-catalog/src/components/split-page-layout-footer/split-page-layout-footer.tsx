...
type SplitPageLayoutFooterViewProps = {
...
export function SplitPageLayoutFooterView({
  padding,
  divider,
  hidden,
  accessibility,
  children,
}: SplitPageLayoutFooterViewProps) {
  return (
    <PrimerSplitPageLayout.Footer
      padding={padding}
      divider={divider}
      hidden={hidden}
...
/**
 * Catalog entry: the generic binder resolves props, then renders SplitPageLayoutFooterView.
 ...
 */
export const SplitPageLayoutFooterComponent = createComponentImplementation(
  SplitPageLayoutFooterApi,
  ({props, buildChild}) => (
