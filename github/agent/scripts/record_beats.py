...
Task 8.1. The agent records what it streams (llm_agent/recorder.py, armed by
...
# The eight beats, verbatim from the task-7.7 rubrics (_dev/docs/beat-verification.md).
# Beat 3 is defined as a follow-up to beat 2, so the two share one conversation.
BEATS: list[Turn] = [
