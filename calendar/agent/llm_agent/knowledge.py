...
Two artifacts, deliberately separate: the brand doc says how to build Calendar's Material 3
...
DOMAIN_KNOWLEDGE_PATH = _KNOWLEDGE_DIR / "calendar-domain.md"
...
def load_domain_knowledge() -> str:
    """Returns the Calendar domain-knowledge prose injected at prompt assembly (build time)."""
