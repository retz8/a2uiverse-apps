"""The Calendar app's kit config — the whole per-vendor surface, stated once."""
...
_AGENT_DIR = Path(__file__).resolve().parents[1]  # calendar/agent/
...
CONFIG = AgentAppConfig(
    ...
    skills=SKILLS,
    default_port=11003,
    responder_app_name="a2ui_calendar_live",
    adk_agent_name="a2ui_calendar_live_agent",
    app_dir=_AGENT_DIR,
    ...
    domain_knowledge_path=_APP_PKG / "knowledge" / "calendar-domain.md",
