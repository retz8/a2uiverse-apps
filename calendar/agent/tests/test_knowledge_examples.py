"""Conformance gate for the curated Calendar-domain idiom examples in `agent/app/knowledge/`.
...
against the shipped Calendar catalog, reusing the deterministic mode's `validate_payload`
