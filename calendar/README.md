...
The agent runs on port **11003**. Live mode reads a seeded demo calendar, never your primary one, and needs a Gemini key and a Google login shared with Gmail — see the [agent README](agent/README.md).
