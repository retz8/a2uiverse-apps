# agent/ — the Shop A app's A2A agent

uv-managed Python project, on port **12001** in every run mode. Built on
...
project carries what is Aperture & Co's — prompt prose, tools, knowledge docs, and the agent card
(`app/`).
...
| `app/knowledge/shop-a-domain.md` | What a camera and a listing are, and what a request is deciding                |
