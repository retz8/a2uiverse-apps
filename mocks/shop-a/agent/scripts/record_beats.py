...
Aperture & Co's: the beats, the agent URL, and the directories.
...
AGENT_URL = "http://localhost:12001"
...
BEATS: list[Turn] = [
    ...
    Turn(2, "open-camera", "One camera", "Tell me about the Lumen X100", chains=True),
