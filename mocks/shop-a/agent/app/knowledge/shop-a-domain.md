...
Shop A is a **mock**: an instrument, not a vendor. There is no shop behind it. Its stock is the
...
Aperture & Co is a boutique dealer: a small hand-picked shelf, each body inspected and graded before listing. A `rating` here is the shop's own assessment after inspection, not a customer score.
