# Shop A brand guidance

Rules for composing A2UI surfaces that read as genuine Shop A product UI, not merely
...
Aperture & Co is a mock store: an instrument whose surfaces exist so a composition over two
