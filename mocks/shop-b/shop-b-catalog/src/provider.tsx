/**
 * The catalog's Provider: Shop B's product tokens, written only on the Provider's
...
/**
 * Wraps every shop-b-catalog surface. `display: contents` keeps the wrapper out of layout;
